...
# TODO: make sure that different functions with equal parameters are cached separately
class memoized(object):
    ...
    def __call__(self, *args):
        if not isinstance(args, collections.Hashable):
            # if args are not hashable forget trying to cache it, just call the function normally
